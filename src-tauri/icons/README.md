...
The source of truth is `../../docs/design/nanoplayer-app-icon-v1.png`. Files in this directory are generated outputs and must not be used as the next generation source.
